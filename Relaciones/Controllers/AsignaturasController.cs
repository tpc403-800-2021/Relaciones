...
namespace Relaciones.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Duracion")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Duracion")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
